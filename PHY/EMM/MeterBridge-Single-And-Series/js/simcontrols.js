window.onload = function () {
  ...
  window.onload = function init() {
    ...
    variableArray = [
      gt.gettext("Resistance System:"),
      gt.gettext("Jockey Position (cm):"),
      gt.gettext("Select Resistance Here"),
    ];
    $(document).ready(function () {
      $("#reset").attr("value", gt.gettext("Restart"));
    ...
    selected_index = 0;
    if (test_class == "1") {
      connectionOptions = [gt.gettext("Single")];
    } else {
      connectionOptions = [gt.gettext("Single"), gt.gettext("Series")];
    }
    addintoDropDown(
      $("#resistors"),
      connectionOptions
  ...
  function keyFn() {
    ...
    if (document.getElementById("key").value == gt.gettext("Remove Key")) {
      document.getElementById("connector").style.visibility = "visible";
      document.getElementById("connector2").style.visibility = "hidden";
